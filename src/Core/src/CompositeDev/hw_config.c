...
* Return         : None
*******************************************************************************/
static void USB_GPIO_Configuration(void)
{
#if (USB_SOFT_CTL_KEY > 0)
...
void USB_PortEn(FunctionalState NewState)
{
...
*******************************************************************************/
static void USB_EXTI_Configuration(void)
{
...
{
  extern void SysTickDlyMs(uint32_t ms);
  USB_PortEn(DISABLE);
