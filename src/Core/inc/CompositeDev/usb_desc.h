/**
  ...
  * @brief   Descriptor Header for Custom HID
  ******************************************************************************
  * @attention
  *
...
#define KEYBOARD_OFF_HID_DESC                   0x29

/*±¨¸æÃèÊö·û*/
#define CUSTOMHID_SIZ_REPORT_DESC               33//31
#define KEYBOARD_SIZ_REPORT_DESC  		65
#define MOUSE_SIZ_REPORT_DESC                   52

#define Composite_SIZ_DEVICE_DESC               18
#define Composite_SIZ_CONFIG_DESC               73//41//
...
#define Composite_SIZ_STRING_MOUSE              12
#define Composite_SIZ_STRING_KEYBOARD           18
#define Composite_SIZ_STRING_HDIDEV             24

#define Composite_NumDevItem                    2
...
extern const unsigned char CustomHID_StringMouse[Composite_SIZ_STRING_MOUSE];
extern const unsigned char CustomHID_StringKeyBoard[Composite_SIZ_STRING_KEYBOARD];
extern const unsigned char CustomHID_StringHIDTxRxDev[Composite_SIZ_STRING_HDIDEV];
